    ...
    return (
        <nav>
            <ul className="list-group">
                <li className="list-group-item"><i className="fa-solid fa-house"></i> Home</li>
                ...
                <li className="list-group-item"><i className="fa-solid fa-calendar-days"></i> Calendar</li>
                <li className="list-group-item"><i className="fa-solid fa-list"></i> List</li>
